/* ============================================================
   ...
   FIELDS:
     ...
     style   — single: "anime"  OR  multi: ["harrypotter","chibi"]
               Use + to combine as many categories as you want.
               Sticker will appear under ALL matching filter tabs.
...
const STICKERS = [
  ...
  { id: 28, name: "Gojo 3",        desc: "Chibi Gojo with a cute smile",                              image: "images/anime/gojo/gojo3.png",                                      style: ["anime", "chibi"],          price: 10, inStock: true  },
  ...
  { id: 22, name: "L Lawliet 1",   desc: "Chibi L Lawliet with his distinctive hairstyle",            image: "images/anime/LLawliet1.png",                                       style: ["anime", "chibi"],          price: 10, inStock: true  },
  ...
  { id: 34, name: "Goku 2",        desc: "Chibi Goku with shadow and super saiyan aura",              image: "images/anime/goku/goku2.png",                                      style: ["anime", "chibi"],          price: 10, inStock: true  },
  ...
  { id: 32, name: "Zoro Swords 1", desc: "Wado Ichimonji, Sandai Kitetsu, and Enma standing together",image: "images/anime/swords/Wado Ichimonji, Sandai Kitetsu, and Enma 1.png", style: "anime",                     price: 10, inStock: true  },
  ...
  { id: 35, name: "Jiraiya 1",     desc: "White-haired ninja with forehead protector and spiral seal", image: "images/anime/jiraiya1.png",                                       style: "anime",                     price: 10, inStock: true  },
  ...
  /* ── HARRY POTTER ── */
  { id: 6,  name: "Harry Potter 1",     desc: "Chibi Harry Potter holding his wand with iconic glasses",      image: "images/harrypotter/HarryPotter1.png",                     style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 7,  name: "Hermione Granger 1", desc: "Chibi Hermione Granger with her characteristic bushy hair",    image: "images/harrypotter/HermioneGranger1.png",                 style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 8,  name: "Ron Weasley 1",      desc: "Chibi Ron Weasley with his red hair and freckles",             image: "images/harrypotter/RonWeasley1.png",                      style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 9,  name: "Rubeus Hagrid 1",    desc: "Chibi Hagrid with his characteristic beard and kind eyes",     image: "images/harrypotter/RubeusHagrid1.png",                    style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 10, name: "Severus Snape 1",    desc: "Chibi Snape with his characteristic scowl and dark hair",      image: "images/harrypotter/SeverusSnape1.png",                    style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 11, name: "Albus Dumbledore 1", desc: "Chibi Dumbledore with long beard and half-moon glasses",       image: "images/harrypotter/AlbusDumbledore1.png",                 style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 12, name: "Draco Malfoy 1",     desc: "Chibi Draco with slicked-back blonde hair and sly expression", image: "images/harrypotter/DracoMalfoy1.png",                     style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  { id: 13, name: "Luna Lovegood 1",    desc: "Chibi Luna with her distinctive hair and dreamy eyes",          image: "images/harrypotter/LunaLovegood1.png",                    style: ["harrypotter", "chibi"],    price: 10, inStock: true  },
  ...
  /* ── MARVEL ── */
  { id: 31, name: "Spider-Man 1",  desc: "Spider-Man hanging in the air with web",                    image: "images/marvel/spiderman1.png",                                     style: "marvel",                    price: 10, inStock: true  },
  ...
  { id: 37, name: "Chibi Spider-Man", desc: "Cute chibi Spider-Man", image: "images/marvel/spiderman-chibi.png", style: ["marvel","chibi"], price: 10, inStock: true },
  */
